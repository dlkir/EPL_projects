...
//    static uint32_t _ID;//for debug: ID
...
//    uint32_t ID;//for debug: ID
      ...
      virtual Action encounter(const ObjInfo&) = 0;//@@ Craig.cpp @@
      virtual std::string species_name(void) const = 0;//@@ Craig.cpp @@
