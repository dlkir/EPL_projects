...
Q1
const_iterator is never used. 

Q2
random foo
error is: std::cout doesn't support.
which means my << had already refused to match with Foo. 

valarray+Foo//don't compile, can't find matching "int my_rank"
valarray+uint64_t//don't compile, can't find matching "int my_rank"


when Foo is incurred, use enable_if to avoid reporting a compile time error???


Q3
write operator+ inside valarray:
what about scalar+valarray???